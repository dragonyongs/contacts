...
//   const modalInputElements = document.querySelectorAll(
//     "#contact-form app-modal-input"
//   );
//   const modalSelectElement = document.querySelector(
//     "#contact-form app-modal-select"
//   );
...
function handleOutsideClick() {
  ...
  if (
    ...
    console.log("modalClose! --- detail");

    this.modalOpen = true;
    this.modalState = "detail";
    this.modalTabState = "";
  } else {
    console.log("modalClose! --- etc");
...
// 등록하기를 누르면 etc조건이 되면서 닫히고
// 만약 add일땐 안닫히게 하면 일반 상황에서도 안닫힌다.

// else if (this.modalTabState === "add") {
//   console.log("modalClose! --- add");
