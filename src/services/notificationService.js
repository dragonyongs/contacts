    ...
    notificationDiv.innerHTML = `
        ...
        <div class="content relative min-h-32">
            <div class="w-11/12">
                ...
                <app-button type="button" role="button" class="small remove-overflow w-48 font-semibold text-2xl text-black bg-white rounded-full" @click="handleConfirmNotificationClick">
